...
At each step, the dominant forces changed. Gravity gave way to surface tension; elastic restoring forces entered the dispersion relation; the coupling between solid deformation and fluid response became primary physics rather than a perturbation. But the _structure_ of the problem was invariant: a deformable boundary, a fluid that cannot ignore it, and a contact condition that neither side determines alone.
